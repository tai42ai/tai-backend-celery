...
def test_no_empty_signal_handlers_remain() -> None:
    """The dead preload/ready/shutdown stubs are gone from the module surface."""
    for name in ("on_preload_parsed", "on_worker_ready", "on_worker_shutdown"):

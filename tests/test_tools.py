...
# Broker-branded names that must not exist on the module.
REMOVED_NAMES = [
    "celery_ping_worker",
    "celery_list_active_workers",
    "celery_task_status",
    "celery_task_result",
    "celery_cancel_task",
    "celery_active_tasks",
    ...
    "celery_registered_tasks",
    "celery_worker_stats",
    "celery_worker_queues",
    "redbeat_delete_schedule",
    "redbeat_list_schedules",
    "redbeat_get_schedule",
    "redbeat_enable_schedule",
    "redbeat_disable_schedule",
    "redbeat_run_schedule_now",
    "redbeat_schedule_exists",
    "redbeat_update_schedule",
]
